...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    public class CloudAnchorManager : MonoBehaviour
    {
        ...
        public void OnEnterHostingModeClick()
        {
			...
			UIManager.Instance().SetRoomTextValue(m_CurrentRoom);
			UIManager.Instance().ShowHostingModeBegin();
        }
        ...
        public void OnEnterResolvingModeClick()
        {
			...
			UIManager.Instance().ShowResolvingModeBegin();
        }
        ...
        private void _HostLastPlacedAnchor()
        {
...
#endif
            UIManager.Instance().ShowHostingModeAttemptingHost();
            XPSession.CreateCloudAnchor(anchor).ThenAction(result =>
            {
                ...
                UIManager.Instance().ShowHostingModeBegin("Cloud anchor was created and saved.");

                GameManager.Instance().matchGroup = m_CurrentRoom.ToString();
